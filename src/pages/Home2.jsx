...
export default function Home2() {
  ...
  <section className={`w-full py-16 ${theme === 'dark' ? 'bg-[#1e3a8a]' : 'bg-[#1e3a8a]'}`} data-aos="fade-up">
  ...
  <section className={`w-full py-16 ${theme === 'dark' ? 'bg-[#181818]' : 'bg-[#FFF]'}`} data-aos="fade-up"> 
