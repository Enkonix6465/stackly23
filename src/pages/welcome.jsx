      ...
      <div className="w-full max-w-md bg-transparent rounded-xl shadow-lg p-8 flex flex-col items-center justify-center">
        {!showSignup && !showForgot ? (
          ...
          <>
            ...
            <h2 className="text-2xl font-bold text-[#1e3a8a] mb-6 text-left w-full">Login</h2>
          ...
          <>
            ...
            <h2 className="text-2xl font-bold mb-6 text-center text-[#1e3a8a]">Reset Password</h2>
          ...
          <>
            ...
            <h2 className="text-2xl font-bold mb-6 text-center text-[#1e3a8a]">Sign Up</h2>
